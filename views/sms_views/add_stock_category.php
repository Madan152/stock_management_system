    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">
                Add Stock Category <small> In this category you can add stock category information.</small>
            </h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                   Add basic information of stock
                </div>
                    ...
                    <form class="" role="form" action="<?php echo base_url() . 'stock/save_stock_category' ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Stock category name" name="category_name" value="" required="required">
                                </div>
                            </div>
                                    ...
                                    <select name="category_type" class="form-control">
                                     <?php 
                                         //$this->load->model('stock_model');
                                            echo $this->stock_model->fill_stock_category(); 
                                        ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Stock category description" name="category_desc"></textarea>
